...
Create a new file `prisma/schema.prisma` and write a basic schema to get started.<SideNote> You can read more about the schema syntax in the [Drizzle docs](https://www.prisma.io/docs/concepts/components/prisma-schema)</SideNote>
