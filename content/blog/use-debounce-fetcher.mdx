...
Using a [custom fetcher hook](/content/remix-rpc-pattern#the-next-step-is-custom-fetcher-hooks), you can add a debounceSubmit function that will only send the last request in a series of rapid-fire requests.

> Jump straight to [the final hook](#the-final-hook) if you're ready to copy/paste.
