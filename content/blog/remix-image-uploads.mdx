---
title: Uploading images in Remix with optimistic UI (like Slack)
...
<div>
  <iframe
    ...
    width="560"
    height="315"
    src="https://www.youtube.com/embed/Y-k1XXRtplk"
...
> To access the source code, [subscribe to my mailing list for free](/emails/subscribe) and **I'll invite you to the repository**
...
The source code for the example is contained in this repository, which all [subscribers to my mailing list](/emails/subscribe) have access to. If you're a subscriber, you can [view the source code here](https://github.com/jacobparis-insiders/jacobparis.com/tree/main/app/examples/remix-image-uploads)
